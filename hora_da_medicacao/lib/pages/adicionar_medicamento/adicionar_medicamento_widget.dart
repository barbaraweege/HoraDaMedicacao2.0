...
/// Tela para adicionar o medicamento
class AdicionarMedicamentoWidget extends StatefulWidget {
  const AdicionarMedicamentoWidget({super.key});

  static String routeName = 'AdicionarMedicamento';
  static String routePath = '/adicionarMedicamento';
...
class _AdicionarMedicamentoWidgetState
  ...
  void initState() {
    ...
    _model.intervaloTextController ??= TextEditingController();
    _model.intervaloFocusNode ??= FocusNode();
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              FlutterFlowDropDown<String>(
                                controller:
                                    _model.dropDownFrequenciaValueController ??=
                                ...
                                onChanged: (val) => safeSetState(
                                    () => _model.dropDownFrequenciaValue = val),
                                width: 400.0,
                                height: 40.0,
                              ...
                              if (_model.dropDownFrequenciaValue ==
                                  'A cada tantas horas')
                                Container(
                                  width: 400.0,
                                  child: TextFormField(
                                    controller: _model.intervaloTextController,
                                    focusNode: _model.intervaloFocusNode,
                                    autofocus: false,
                                    obscureText: false,
                                    decoration: InputDecoration(
                                      isDense: true,
                                    ...
                                    cursorColor: FlutterFlowTheme.of(context)
                                        .primaryText,
                                    validator: _model
                                        .intervaloTextControllerValidator
                                        .asValidator(context),
                                  ),
                                ),
                              Row(
                              ...
                              if (_model.switchContinuoValue == false)
                                Container(
                                  ...
                                  child: TextFormField(
                                    ...
                                    focusNode:
                                        _model.textFieldDiaInicioFocusNode,
                                    autofocus: false,
                                    obscureText: false,
                                    decoration: InputDecoration(
                              ...
                              Container(
                                width: 400.0,
                                child: TextFormField(
                                  controller: _model.dosagemTextController,
                              ...
                              Row(
                                ...
                                children: [
                                  Text(
                                    'Horário atual: ${valueOrDefault<String>(
                                      dateTimeFormat(
                                        "Hm",
                                        getCurrentTimestamp,
                              ...
                              FFButtonWidget(
                                onPressed: () async {
                                  context.pushNamed(
                                    GerenciarAlarmesWidget.routeName,
                                    extra: <String, dynamic>{
                                      kTransitionInfoKey: TransitionInfo(
                                        hasTransition: true,
                                        transitionType: PageTransitionType.fade,
                                  ...
                                  await MedicamentoTable().insert({
                                    'nome': _model
                                        .nomeMedicamentoTextController.text,
                                    'frequencia':
                                        _model.dropDownFrequenciaValue,
                                    'dosagem':
                                        _model.dosagemTextController.text,
                                    'uso_continuo': _model.switchContinuoValue,
                                    'intervalo_horas': int.tryParse(
                                        _model.intervaloTextController.text),
                                    'hora_primeira_dose':
                                        supaSerialize<DateTime>(
                                            getCurrentTimestamp),
                                    'dia_inicio': _model
                                        .textFieldDiaInicioTextController.text,
                                    'dia_fim': _model
                                        .textFieldDiaFimTextController.text,
                                  });
                                },
